...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('@egjs/component'), require('three/examples/jsm/loaders/RGBELoader'), require('three/examples/jsm/lights/LightProbeGenerator'), require('three/examples/jsm/loaders/GLTFLoader'), require('three/examples/jsm/loaders/DRACOLoader'), require('three/examples/jsm/loaders/KTX2Loader')) :
  typeof define === 'function' && define.amd ? define(['three', '@egjs/component', 'three/examples/jsm/loaders/RGBELoader', 'three/examples/jsm/lights/LightProbeGenerator', 'three/examples/jsm/loaders/GLTFLoader', 'three/examples/jsm/loaders/DRACOLoader', 'three/examples/jsm/loaders/KTX2Loader'], factory) :
  (global = global || self, global.View3D = factory(global.THREE, global.Component, global.RGBELoader, global.LightProbeGenerator, global.GLTFLoader, global.DRACOLoader, global.KTX2Loader));
}(this, (function (THREE, Component, RGBELoader, LightProbeGenerator, GLTFLoader$1, DRACOLoader, KTX2Loader) { 'use strict';
