...
class FaceAnnotation extends Annotation {
  ...
  _getPosition() {
    ...
    if (!animatedVertices) return new Vector3(); // barycentric
...
class NavigationGizmo {
  ...
  constructor(view3D, controlBar, {
    ...
    this._onRender = () => {
      ...
      const zColor = new Color(this.zAxisColor); // Sorted by distance, ASC
