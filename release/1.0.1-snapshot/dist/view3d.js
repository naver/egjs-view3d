...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('three/examples/jsm/loaders/GLTFLoader'), require('three/examples/jsm/loaders/DRACOLoader'), require('three/examples/jsm/loaders/RGBELoader')) :
    typeof define === 'function' && define.amd ? define(['three', 'three/examples/jsm/loaders/GLTFLoader', 'three/examples/jsm/loaders/DRACOLoader', 'three/examples/jsm/loaders/RGBELoader'], factory) :
    (global = global || self, global.View3D = factory(global.THREE, global.GLTFLoader$1, global.DRACOLoader, global.RGBELoader));
}(this, (function (THREE, GLTFLoader$1, DRACOLoader, RGBELoader) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function () {
      ...
      __proto.on = function (eventName, callback) {
        ...
        var listeners = listenerMap.get(eventName);
      ...
      __proto.emit = function (eventName) {
        ...
        var listeners = this._listenerMap.get(eventName);
    ...
    function getBoxPoints(box) {
      return [box.min.clone(), new THREE.Vector3(box.min.x, box.min.y, box.min.z), new THREE.Vector3(box.min.x, box.max.y, box.min.z), new THREE.Vector3(box.min.x, box.max.y, box.max.z), new THREE.Vector3(box.max.x, box.min.y, box.min.z), new THREE.Vector3(box.max.x, box.min.y, box.max.z), new THREE.Vector3(box.max.x, box.max.y, box.min.z), box.max.clone()];
    }
    ...
    var IS_SAFARI = /safari/i.test(navigator.userAgent); // tslint:disable-next-line naming-convention
    ...
    function () {
      ...
      __proto.updateRoation = function (rotation) {
    ...
    function () {
      ...
      __proto.process = function (_a, _b) {
        ...
        var rotationAngle = getRotationAngle(ndcModelPos, prevPos, coord);
    ...
    function () {
      ...
      __proto.activate = function (_a, gesture) {
        ...
        if (gesture === GESTURE.TWO_FINGER_HORIZONTAL) {
          rotationIndicator.updateRoation(model.scene.quaternion.clone().multiply(new THREE.Quaternion().setFromEuler(new THREE.Euler(-Math.PI / 2, 0, 0))));
          this._state = STATE$2.ROTATE_HORIZONTAL;
        } else if (gesture === GESTURE.TWO_FINGER_VERTICAL) {
          rotationIndicator.updateRoation(model.scene.quaternion.clone().multiply(new THREE.Quaternion().setFromEuler(new THREE.Euler(0, Math.PI / 2, 0))));
      ...
      __proto.process = function (ctx, _a) {
        ...
        var rotationAngle = state === STATE$2.ROTATE_HORIZONTAL ? posDiff.x : -posDiff.y;
