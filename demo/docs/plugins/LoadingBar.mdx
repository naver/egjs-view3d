...
|barBackground|string|"#bbbbbb"|Loading bar's background color in CSS string|
|barForeground|string|"#3e8ed0"|Loading bar's foreground color in CSS string|
|overlayBackground|string|"rgba(0, 0, 0, 0.3)"|Overlay's background color in CSS string|
