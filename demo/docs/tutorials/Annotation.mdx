...
<div class="view3d-wrapper">
  <canvas class="view3d-canvas"></canvas>
  <div class="view3d-annotation-wrapper">
    <div class="view3d-annotation default" data-mesh-index="7" data-face-index="5" data-focus="0 0 15" data-duration="500">
      <div class="view3d-annotation-tooltip default">A thick eyebrow</div>
    </div>
    <div class="view3d-annotation default" data-mesh-index="15" data-face-index="5" data-focus="30 15 30" data-duration="200">
...
<>{(() => {
  ...
  return <View3D
    ...
    showExampleCode>
    <div className="view3d-annotation-wrapper">
      <div className="view3d-annotation default" data-mesh-index="7" data-face-index="5" data-focus="0 0 15" data-duration="500">
        <div className="view3d-annotation-tooltip default">A thick eyebrow</div>
      </div>
      <div className="view3d-annotation default" data-mesh-index="15" data-face-index="5" data-focus="30 15 30" data-duration="200">
...
Annotations can be included in glTF files when saving 3D models with [Playground](/Playground)
...
<License items={[
  ...
  },
  {
    ...
    link: "https://polyhaven.com/a/sepulchral_chapel_rotunda",
    author: "Poly Haven",
    authorLink: "https://polyhaven.com/",
    license: "CC0"
  }
