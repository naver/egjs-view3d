...
|---|:---:|:---:|
|Korean Fire Extinguisher 01|5.95MB|1.37MB (-27.67%)|
...
## Example
<View3D src="/model/meshopt/watch.glb" envmap="/texture/comfy_cafe_1k.hdr" showExampleCode={["ktxPath"]} />

<License items={[
  {
    name: "Korean Fire Extinguisher 01",
    link: "https://polyhaven.com/a/korean_fire_extinguisher_01",
    author: "Poly Haven",
