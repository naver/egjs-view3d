...
## Example
### pitch: 0 (default)
<View3D src="/egjs-view3d/model/draco/alarm.glb" pitch={0} envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" showExampleCode />

### pitch: -45
<View3D src="/egjs-view3d/model/draco/alarm.glb" pitch={-45} envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" showExampleCode />
