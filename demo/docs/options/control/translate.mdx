...
<View3D src="/egjs-view3d/model/meshopt/alarm.glb" envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" translate={true} showExampleCode />

### translate: false
<View3D src="/egjs-view3d/model/meshopt/alarm.glb" envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" translate={false} showExampleCode />

### Detailed options
<View3D src="/egjs-view3d/model/meshopt/alarm.glb" envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" translate={{
  scale: 2,
  duration: 2000
}} showExampleCode />
