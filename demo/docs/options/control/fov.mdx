...
## Example
### fov: "auto" (default)
<View3D src="/egjs-view3d/model/meshopt/alarm.glb" fov="auto" envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" showExampleCode />

### fov: 120
<View3D src="/egjs-view3d/model/meshopt/alarm.glb" fov={120} envmap="/egjs-view3d/texture/artist_workshop_1k.hdr" showExampleCode />
