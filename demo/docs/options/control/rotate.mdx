...
## Example
### rotate: true
<View3D src="/model/meshopt/alarm.glb" envmap="/texture/artist_workshop_1k.hdr" rotate={true} showExampleCode />

### rotate: false
<View3D src="/model/meshopt/alarm.glb" envmap="/texture/artist_workshop_1k.hdr" rotate={false} showExampleCode />

### Detailed options
<View3D src="/model/meshopt/alarm.glb" envmap="/texture/artist_workshop_1k.hdr" rotate={{
  scale: 5,
  duration: 2000
}} showExampleCode />
