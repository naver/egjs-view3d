...
## Example
### Number
<View3D src="/model/meshopt/alarm.glb" envmap="/texture/artist_workshop_1k.hdr" background={0x456456} showExampleCode />

### Hex Color String
<View3D src="/model/meshopt/alarm.glb" envmap="/texture/artist_workshop_1k.hdr" background="#654654" showExampleCode />

### Texture URL
<View3D src="/model/meshopt/alarm.glb" envmap="/texture/artist_workshop_1k.hdr" background="/img/nopensource.png" showExampleCode />
