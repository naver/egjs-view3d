...
<View3D showBbox src="/model/trex.glb" envmap="/texture/spruit_sunrise_1k.hdr" showExampleCode />

### fixSkinnedBbox: true
<View3D showBbox src="/model/trex.glb" envmap="/texture/spruit_sunrise_1k.hdr" fixSkinnedBbox={true} showExampleCode />
