...
import { clamp } from "../../../../../view3d/src/utils";
import { ANNOTATION_EXTRA, TEXTURE_LOD_EXTRA } from "../../../../../view3d/src/const/internal";

import HelpIcon from "@site/static/icon/help.svg";
import DownloadIcon from "@site/static/icon/file_download_black.svg";

class DownloadModel extends React.Component {
  ...
  public render() {
    ...
    return <Collapse title="Download 3D Model">
      <div className="is-flex is-flex-direction-row is-align-items-center">
        ...
        <span className="icon is-small ml-1" style={{ verticalAlign: "top" }}	data-place="right" data-tip="WebP images are smaller than jpeg/png images, but have lesser browser coverage. png/jpeg images will be used as fallback."><HelpIcon style={{ fill: "#7a7a7a" }} /></span>
      </div>
      <div className="is-flex is-flex-direction-row is-align-items-center">
        ...
        <span className="icon is-small ml-1" style={{ verticalAlign: "top" }}	data-place="right" data-tip="Include multiple levels(sizes) of textures. Low-res textures will be loaded first, and will be replaced with highres textures after they're loaded."><HelpIcon style={{ fill: "#7a7a7a" }} /></span>
      </div>
      <div className="is-flex is-flex-direction-row is-align-items-center">
      ...
      <button className="button is-small mt-2" disabled={state.isLoading} onClick={() => this._downloadModel(state, dispatch)}>
  ...
  private async _downloadModel(state, dispatch) {
    const view3D = state.view3D;
...
DownloadModel.contextType = Context;
